...
POSTGRES_JDBC_DRIVER=$PIO_HOME/postgresql-42.1.4.jar
...
PIO_STORAGE_REPOSITORIES_HISTORYDATA_NAME=pio_history
PIO_STORAGE_REPOSITORIES_HISTORYDATA_SOURCE=PGSQL
...
PIO_STORAGE_SOURCES_PGSQL_URL=jdbc:postgresql://v-dev-ubudsk-2/pio
